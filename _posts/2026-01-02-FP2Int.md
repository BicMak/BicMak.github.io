...
제공해주신 이미지들에 포함된 주요 수식들을 활용 목적에 맞게 **Markdown**과 **LaTeX**으로 정리해 드립니다.

### 2.1. 양자화된 행렬 곱셈 (Quantized Matrix Multiplication)

---

행렬 곱 $\mathbf{Y = WX}$를 양자화된 도메인에서 계산하기 위한 수식 전개 과정입니다.
...
### 4. 하드웨어 최적화 트릭 (Fixed-point & Precompute)
...
- Multiplier ($M_{0}$) 근사 (이미지 1):
    ...
    (여기서 $2^{-n}$은 Bit Shift, $M_0$는 Fixed-point Multiplication으로 처리됩니다.)
